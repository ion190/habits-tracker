...
export function IconBook() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M2 3h12M2 7.5h8M2 12h10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  )
}
...
export function IconDumbbell() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <rect x="1" y="6.5" width="3" height="3" rx="1" stroke="currentColor" strokeWidth="1.5" />
      <rect x="12" y="6.5" width="3" height="3" rx="1" stroke="currentColor" strokeWidth="1.5" />
      <path d="M4 8h8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <rect x="5.5" y="5" width="2" height="6" rx="1" stroke="currentColor" strokeWidth="1.5" />
      <rect x="8.5" y="5" width="2" height="6" rx="1" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  )
}
